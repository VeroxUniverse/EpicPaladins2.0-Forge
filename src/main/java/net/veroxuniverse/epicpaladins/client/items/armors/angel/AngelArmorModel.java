...
public class AngelArmorModel extends GeoModel<AngelArmorItem> {
    ...
    public ResourceLocation getModelResource(AngelArmorItem animatable) {
        return new ResourceLocation(EpicPaladinsMod.MOD_ID, "geo/angel_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AngelArmorItem animatable) {
        return new ResourceLocation(EpicPaladinsMod.MOD_ID, "textures/armor/angel_armor_textures.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AngelArmorItem animatable) {
       return new ResourceLocation(EpicPaladinsMod.MOD_ID, "animations/armor/angel_armor_animation.json");
    }
}
